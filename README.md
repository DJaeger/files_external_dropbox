...
Requires Nextcloud 12.0 to 13.0
...
- Download the [source](https://github.com/icewind1991/files_external_dropbox/archive/v1.0.0.zip) into the Nextcloud apps directory.
